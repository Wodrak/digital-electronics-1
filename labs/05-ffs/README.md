...
1. Write characteristic equations and complete truth tables for D, JK, T flip-flops where `q(n)` represents main output value before the clock edge and `q(n+1)` represents output value after the clock edge.
   ...
   ![Characteristic equations](images/CodeCogsEqn.png)
   <!--
   https://editor.codecogs.com/
   \begin{align*}
       q_{n+1}^D =&~d \\
       q_{n+1}^{JK} =&j\overline{q}_{n}+\overline{k}q_{n} \\       
       q_{n+1}^T =&t\overline{q}_{n}+\overline{t}q_{n} \\
   \end{align*}
   -->
   ...
   **JK-type FF**
   ...
   | :-: | :-: | :-: | :-: | :-: | :-- |
   | ![rising](images/eq_uparrow.png) | 0 | 0 | 0 | 1 | Output did not change |
   | ![rising](images/eq_uparrow.png) | 0 | 0 | 1 | 0 | Output did not change |
   | ![rising](images/eq_uparrow.png) | 0 | 1 | 0 | 1 |  |
   | ![rising](images/eq_uparrow.png) | 0 | 1 | 1 | 1 |  |
   | ![rising](images/eq_uparrow.png) | 1 | 0 | 0 | 0 |  |
   | ![rising](images/eq_uparrow.png) | 1 | 0 | 1 | 0 |  |
   | ![rising](images/eq_uparrow.png) | 1 | 1 | 0 | 0 |  |
